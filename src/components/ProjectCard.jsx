...
function ProjectCard ({url, urlButton, image, title, children}){
  ...
  return (
    <article className='bg-slate-800 p-10 rounded-3xl flex flex-col items-center m-2 w-[22rem] mt-6'>
        <img src={image} className='w-60 h-60 object-cover overflow-hidden rounded-lg hover:scale-110 transition-all'/>
        ...
        <p className='w-60 h-36 overflow-hidden'>{children}</p>
