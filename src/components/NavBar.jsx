...
const NavBar = () => {
  ...
  return (
    <nav className="flex fixed w-full justify-between items-center text-gray-200 px-8 md:px-32 mt-8">
      <a href="#HOME">
            <img className="w-24 hover:scale-110 transition-all" src="https://raw.githubusercontent.com/hectorniz/portfolio/c7af291660893aae6c93afbd705d31f5807362dc/src/assets/logo.svg" alt="logo"/>
      </a>
